...
public sealed class EmployeeSalaryCreateValidation : AbstractValidator<EmployeeSalaryCreateCommand>
{
    private static readonly string[] AllowedCalculators = ["CalcurlatorA", "CalcurlatorB", "CalcurlatorC"];

    public EmployeeSalaryCreateValidation(ITranslator translator)
    {
